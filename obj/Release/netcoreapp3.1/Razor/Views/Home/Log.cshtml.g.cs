#pragma checksum "C:\Users\User\Desktop\C#stuff\HistoryServer\Views\Home\Log.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "32c9485f4981dabdbb159ffa233a0f6c0e0dea74"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"32c9485f4981dabdbb159ffa233a0f6c0e0dea74", @"/Views/Home/Log.cshtml")]
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "32c9485f4981dabdbb159ffa233a0f6c0e0dea743190", async() => {
                WriteLiteral(@"
    <style> 
        html {
    ...
    <div class=""text-center"">
        ...
        <p id=""text"">
            ...
            В <ins>Resources.resx</ins> добавлены фотографии всех членов семьи Романовых, указ");
                WriteLiteral(@"анных в древе
            ...
            Написана перегрузка конструктора Form2, приним");
                WriteLiteral(@"ающая аргументы <code>string data</code> и <code>System.Drawing.Image</code> image
            ...
            <hr />
            Создан новый проект <mark>Asp.Net MVC (Model-view-controller)</mark>. Изменены автоматически сгенерированные файлы <ins>Index.cshtml</ins> и <ins>_Layout.cshtml</ins>, <ins>Privacy.cshtml</ins> изменён на <ins>Result.cshtml</ins> (перемещен в папку <ins>Views/Quiz</in");
                WriteLiteral(@"s> из <ins>Views/Home</ins>). Добавлен контроллер <code>QuizController</code> И razor страница <ins>Quiz.cshtml</ins>. Добавлены модели <code>Database</code> (статический), <code>Student</code>, <code>Question</code>, <code>Questions</code> (статический).
            ...
            В Quiz.cshtml написан <mark id=""bad-programming-language"">Jav");
                WriteLiteral(@"aScript</mark> код для <ins>frontend</ins> части, отвечающий за таймер, кнопки, и переходы.
            ...
            Отправляет HTTP запрос на сервер, в качестве ответа ожидает <var>JSON</var> строку, сериализует полученную строку используя <code>JsonSerializer</code> из <code>System.Text.Json</code>, а после этого ставит её ");
                WriteLiteral(@"как источник данных у <code>DataGridView</code>
            ...
            чтобы зашифровать текст, мы проходим цикло");
                WriteLiteral(@"м по каждому символу в строке, и ищем этот символ в другой строке: allowedChars
            ...
            Также, следует отметить, что сайт не имеет входных точек для файлов или URL, это исключает <var>Remot");
                WriteLiteral(@"e Code Execution</var> и <var>SSRF</var> атаки соответственно
